...
if modification == "combi":
    ...
    lambda_r = 2.95e-10#2.95e-09
    lambda_l2 = 1.00e-19#1.00e-18
...
try:
    os.mkdir(f"final_merfish_mouse_hypothalamus_modifications/{modification}/") 
...
for run in range(10):
    ...
    np.save(f"final_merfish_mouse_hypothalamus_modifications/{modification}/{run}.npy", adata_maps_pred[run].X)