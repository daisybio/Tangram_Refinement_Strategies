...
if modification == "cytospace_preprocess":
    adata_sc = an.read_h5ad("data/visium_mouse_cortex_sc_cytospace_preprocessed.h5ad")
elif modification == "cytospaceT_preprocess" or modification == "cytospaceT_combi_new":
    adata_sc = an.read_h5ad("data/visium_mouse_cortex_sc_cytospace_preprocessed_Tangrambased.h5ad")
elif modification == "constrained_preprocess" or modification == "constrained_combi" or modification == "constrained_combi_new":
    adata_sc = an.read_h5ad("data/visium_mouse_cortex_constrained.h5ad")
else:
    adata_sc = sq.datasets.sc_mouse_cortex()

genes = None 
if modification == "combi" or modification == "constrained_combi" or modification == "cytospace_combi":
...
try:
    os.mkdir(f"final_visium_mouse_cortex_modifiations/{modification}/") 
...
for run in range(10):
    ...
    np.save(f"final_visium_mouse_cortex_modifiations_new/{modification}/{run}.npy", adata_maps_pred[run].X)