...
if modification == "combi":
    ...
    lambda_r = 2.95e-08#2.95e-09
    lambda_l2 = 1.00e-17#1.00e-18
...
try:
    os.mkdir(f"final_seqfish+_mouse_cortex_modifiations/{modification}/") 
...
for run in range(10):
    ...
    np.save(f"final_seqfish+_mouse_cortex_modifiations/{modification}/{run}.npy", adata_maps_pred[run].X)